...
class DataTrainingArguments:
    ...
    do_analysis: bool = field(
        default=False, metadata={"help": "whether show analysis outputs."}
    )
    lang: Optional[str] = field(
        default=None, metadata={"help": "A lanuage for evaluation."}
    )
...
class ModelArguments:
    ...
    fix_bert: bool = field(
        default=False,
        metadata={"help": "Whether to fix bert representation during fine-tuning."},
    )
...
def get_args():
    ...
    parser = HfArgumentParser((ModelArguments, DataTrainingArguments, Seq2SeqTrainingArguments, QuestionAnwseringArguments))
